...
(use-package modus-themes
  :straight t
  :config
  (setq modus-themes-theme-fringes 'subtle)
  (setq modus-themes-theme-bold-constructs t)
  (setq modus-themes-theme-org-blocks 'greyscale)
  (setq modus-themes-theme-org-habit 'traffic-light)
  (setq modus-themes-theme-scale-headings t)
